...
describe("assertTestDatabase", () => {
  it("acepta exclusivamente la base de integracion", () => {
    const url = "postgresql://postgres:postgres@localhost:5432/somos-barrio-test?schema=public";
  ...
  it.each([
    undefined,
    "not-a-url",
    "postgresql://postgres:postgres@localhost:5432/somos-barrio?schema=public",
